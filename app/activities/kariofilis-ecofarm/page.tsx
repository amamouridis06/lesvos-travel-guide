                ...
                <div className="relative z-10 flex h-full items-center justify-center px-6 text-center">
                    <div className="max-w-3xl text-white">
                        ...
                        <p className="mx-auto max-w-2xl text-lg text-stone-200 md:text-xl">
                            Μια αυθεντική farm-to-table εμπειρία όπου η φύση,
                            η τοπική γαστρονομία και η φιλοξενία ενώνονται.
                        </p>
                ...
                <div className="grid gap-12 md:grid-cols-2 md:items-center">
                    <div>
                        ...
                        <h2 className="mb-6 text-4xl font-bold">
                            Εκεί όπου η φάρμα συναντά τη γαστρονομία
                        </h2>
                    ...
                    <div className="grid gap-8 md:grid-cols-3">
                        <div className="rounded-3xl bg-stone-50 p-8 shadow-lg">
                            ...
                            <p className="leading-7 text-stone-600">
                                Περιηγηθείτε στους κήπους, γνωρίστε τις καλλιέργειες και
                                ανακαλύψτε την αυθεντική αγροτική ζωή.
                            </p>
                        </div>
                        ...
                        <div className="rounded-3xl bg-stone-50 p-8 shadow-lg">
                            ...
                            <p className="leading-7 text-stone-600">
                                Απολαύστε πιάτα εμπνευσμένα από τη μεσογειακή κουζίνα,
                                βασισμένα σε τοπικά και φρέσκα προϊόντα.
                            </p>
                        </div>
                        ...
                        <div className="rounded-3xl bg-stone-50 p-8 shadow-lg">
                            ...
                            <p className="leading-7 text-stone-600">
                                Cooking classes, γευσιγνωσίες, περιηγήσεις και μοναδικές
                                εμπειρίες μέσα στη φύση.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-5 text-lg text-stone-600">
                            <div className="flex items-start gap-4">
                                ...
                                <p>Αυθεντική farm-to-table εμπειρία</p>
                            </div>

                            <div className="flex items-start gap-4">
                                <span className="mt-1 text-emerald-700">✓</span>
                                <p>Τοπική μεσογειακή γαστρονομία</p>
                            </div>

                            <div className="flex items-start gap-4">
                                <span className="mt-1 text-emerald-700">✓</span>
                                <p>Ιδανικό για οικογένειες και food travelers</p>
                            </div>

                            <div className="flex items-start gap-4">
                                <span className="mt-1 text-emerald-700">✓</span>
                                <p>Δραστηριότητες μέσα στη φύση</p>
                            </div>

                            <div className="flex items-start gap-4">
                                <span className="mt-1 text-emerald-700">✓</span>
                                <p>Χαλαρωτική και αυθεντική ατμόσφαιρα</p>
                            </div>
                        </div>
                    </div>
                </div>
