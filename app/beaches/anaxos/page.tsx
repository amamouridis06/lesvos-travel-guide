...
const quickFacts = [
  ...
  { value: "Long sandy coastline", label: "Beach" },
  { value: "Swimming", label: "Clear and inviting sea" },
  { value: "Families", label: "Child-friendly facilities" },
  { value: "Food", label: "Seafront tavernas and cafés" },
