...
export default function LimanakiPamfilonPage() {
  ...
  return (
    <main className="bg-neutral-100 text-neutral-900 min-h-screen">
      ...
      <section className="relative h-[60vh] md:h-[70vh] w-full">
        ...
        <div className="absolute bottom-6 md:bottom-10 left-1/2 -translate-x-1/2 text-center text-white px-4 md:px-6 max-w-3xl">
  ...
  local recipes, and a variety of meze, perfectly paired with ouzo or tsipouro.
            ...
            <div className="flex gap-2 md:gap-3 mt-3 md:mt-4 overflow-x-auto pb-2">
              {images.map((img, i) => (
                <div
                  key={i}
                  onClick={() => setIndex(i)}
                  className={`relative w-20 md:w-24 h-14 md:h-16 rounded-lg overflow-hidden cursor-pointer border-2 flex-shrink-0 ${
        ...
        <aside className="space-y-6 md:space-y-10">
          ...
          <div className="bg-white rounded-xl shadow p-4 md:p-6">
            ...
            <ul className="text-xs md:text-sm space-y-2 md:space-y-3 text-gray-700">
              ...
              <li><strong>Suitable for:</strong> Families</li>
            </ul>
          </div>
      ...
      {isOpen && (
        ...
        >
          <div className="relative w-full max-w-5xl h-[80vh]">
            ...
            <button
              onClick={(e) => { e.stopPropagation(); prev(); }}
              className="absolute left-4 md:left-6 top-1/2 text-white text-3xl"
            >
              ‹
            </button>
            ...
            <button
              onClick={(e) => { e.stopPropagation(); next(); }}
              className="absolute right-4 md:right-6 top-1/2 text-white text-3xl"
            >
              ›
            </button>
      ...
      {/* CTA */}
      <section className="bg-neutral-900 text-white py-14 md:py-20 text-center px-4">
