          ...
          <div className="grid gap-8 md:gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-end lg:gap-12">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur sm:p-5">
                <p className="text-xs text-white/60 sm:text-sm">Περιοχές βάσης</p>
                <p className="mt-2 text-xl font-bold sm:text-2xl">3</p>
              </div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur sm:p-5">
                <p className="text-xs text-white/60 sm:text-sm">Ημέρες planner</p>
                <p className="mt-2 text-xl font-bold sm:text-2xl">1–10</p>
              </div>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur sm:p-5">
                <p className="text-xs text-white/60 sm:text-sm">Στυλ προγράμματος</p>
