...
const quickFacts = [
  { label: "Region", value: "Southern Lesvos" },
  { label: "Postal Code", value: "81200" },
  { label: "Near", value: "Plomari" },
  { label: "Landscape", value: "Olive Groves" },
  { label: "Ideal For", value: "Nature & Slow Travel" },
...
const highlights = [
  {
    ...
    text: "Experience authentic village life in one of southern Lesvos' peaceful settlements.",
  },
  {
    icon: Landmark,
    title: "Local Heritage",
    text: "Stone houses, quiet streets and traditional architecture reflect the island's rural history.",
  },
  {
    icon: Sun,
    title: "Olive Landscape",
    text: "Surrounded by centuries-old olive groves that define the landscape of southern Lesvos.",
  },
  {
    icon: Navigation,
    title: "Close to Plomari",
    text: "An excellent base for exploring Plomari, Melinda and the southern coast.",
  },
];
...
const practicalInfo = [
  {
    ...
    values: [
      "🌸 Spring for green landscapes, wildflowers and peaceful walks",
      "☀️ Summer for quiet village evenings near the Plomari coastline",
      "🍂 Autumn for olive groves, soft light and harvest atmosphere",
    ],
  },
  {
    icon: Car,
    ...
    values: [
      "🚗 A car is recommended for visiting Trygona and nearby villages",
      "🥾 Best explored slowly on foot through its quiet streets",
    ],
  },
  {
    icon: Star,
  ...
  },
  {
    ...
    label: "Local Tip",
    values: [
      "Combine Trygona with Plomari, Plagia and Melinda for a relaxed day exploring southern Lesvos.",
    ],
  },
];
...
const nearbyPlaces = [
  {
    title: "Plomari (10 min)",
    text: "The ouzo capital of Lesvos, with seaside cafés, tavernas and neoclassical charm.",
    href: "/villages/plomari",
    icon: Landmark,
  },
  {
    title: "Plagia (5 min)",
    text: "A nearby traditional village surrounded by olive groves and quiet countryside.",
    href: "/villages/plagia",
    icon: Home,
  },
  {
    title: "Melinda Beach (15 min)",
    text: "A peaceful beach with clear waters, tavernas and a relaxed southern Lesvos feeling.",
    href: "/beaches/melinda",
    icon: Sun,
  },
  {
    title: "Agios Isidoros (15 min)",
    text: "One of the most popular beaches near Plomari, known for its clear blue waters.",
    href: "/beaches/agios-isidoros",
    icon: Waves,
  },
];
...
export default function TrygonaPage() {
  return (
      <main className="overflow-hidden bg-[#f6f1e8] text-stone-950">
            ...
            <div className="grid w-full gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:items-end">
              ...
              >
                ...
                <p className="mt-8 max-w-2xl text-base leading-7 text-white/70 sm:text-lg">
                  Hidden among the olive-covered hills of southern Lesvos, Trygona is a
                  peaceful traditional village where authentic island life continues at a
                  gentle pace. Close to Plomari and the southern coastline, it offers a
                  relaxing escape surrounded by nature, history and local hospitality.
                </p>
        ...
        >
          <div>
            <SectionHeading
                eyebrow="Why visit Trygona"
                title="A peaceful village surrounded by olive groves"
                description="Trygona is ideal for travellers who want to experience the quieter, traditional side of southern Lesvos, close to Plomari, Plagia and the island’s olive-covered countryside."
            />
