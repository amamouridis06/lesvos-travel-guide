...
const quickFacts = [
  ...
  { label: "Best Known For", value: "Traditional Village" },
  { label: "Historical Roots", value: "Ancient Antissa" },
  { label: "Nearby Attraction", value: "Petrified Forest" },
  { label: "Character", value: "Authentic & Peaceful" },
];
...
const highlights = [
  {
    ...
    text: "Built near the site of ancient Antissa, one of the historic city-states of Lesvos.",
  },
  {
    icon: Home,
    title: "Traditional Village",
    text: "Experience authentic village life, stone houses and welcoming local cafés.",
  },
  {
    icon: Palette,
    title: "Local Culture",
    text: "A place where traditional customs and everyday island life remain unchanged.",
  },
  {
    icon: Sun,
    title: "Gateway to Western Lesvos",
    text: "An ideal base for exploring the Petrified Forest, Sigri and the island's volcanic landscapes.",
  },
];
...
const practicalInfo = [
  {
    ...
    values: [
      "🌸 April–May: Green countryside and pleasant temperatures",
      "☀️ June–September: Ideal for combining village visits with nearby beaches",
      "🍂 October: Peaceful atmosphere and mild weather",
    ],
  },
  {
    icon: Car,
    ...
    values: [
      ...
      "🚌 Bus services connect Antissa with Mytilene",
    ],
  },
  {
    icon: Star,
  ...
  },
  {
    ...
    label: "Local Tip",
    values: [
      "Combine Antissa, Sigri and the Petrified Forest for a journey through the most distinctive landscapes of Lesvos.",
    ],
  },
];
  ...
  return (
      <main className="overflow-hidden bg-[#f6f1e8] text-stone-950">
            ...
            <div className="grid w-full gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:items-end">
              ...
              >
                ...
                <p className="mt-8 max-w-2xl text-base leading-7 text-white/68 sm:text-lg sm:leading-8 md:text-xl">
                  Antissa is a traditional village in western Lesvos, surrounded by olive groves and rolling countryside. Rich in history and local character, it offers visitors an authentic glimpse into rural island life while serving as a gateway to some of Lesvos' most remarkable natural attractions.
                </p>
        ...
        >
          <div>
            <SectionHeading
                eyebrow="Why visit Antissa"
                title="A glimpse into authentic western Lesvos"
                description="Far from the island's busiest resorts, Antissa offers traditional village charm, historic roots and easy access to the volcanic landscapes that make western Lesvos unique."
            />
            ...
            <motion.div {...fadeUp} className="mt-9 border-l-2 border-amber-400 pl-5">
              <p className="text-xl font-semibold leading-8 text-stone-800">
                “Where history meets the countryside.”
              </p>
            </motion.div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
              ...
              >
                ...
                <a
                    href="https://maps.app.goo.gl/2ZMDmD9t51oJety38"
                    target="_blank"
                    rel="noreferrer"
              ...
              >
                ...
                <div className="h-[430px] sm:h-[540px]">
                  <iframe
                      title="Map of Gavathas"
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3265.236436955341!2d25.97314775!3d39.2813911!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14babe9506469931%3A0x106a2ea2bfee6249!2sGavathas!5e1!3m2!1sen!2sgr!4v1781713095688!5m2!1sen!2sgr"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      loading="lazy"
