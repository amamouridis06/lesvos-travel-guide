...
const quickFacts = [
  ...
  { label: "Distance from Mytilene", value: "58 km" },
  { label: "Altitude", value: "320 m" },
  { label: "Best Known For", value: "Stone Architecture" },
  { label: "Ideal For", value: "Nature & Hiking" },
...
const highlights = [
  {
    ...
    text: "Beautiful stone houses, flower-filled courtyards and authentic island character.",
  },
  {
    icon: Landmark,
    title: "Historic Village",
    text: "A peaceful settlement preserving centuries of local culture and architecture.",
  },
  {
    icon: Sun,
    title: "Panoramic Views",
    text: "Enjoy spectacular views towards Petra, Molyvos and the northern Aegean.",
  },
  {
    icon: Navigation,
    title: "Walking Trails",
    text: "Perfect starting point for hiking through olive groves and surrounding countryside.",
  },
];
...
const practicalInfo = [
  {
    ...
    values: [
      "🌸 Spring for wildflowers and hiking",
      "☀️ Summer for cooler mountain evenings",
      "🍂 Autumn during the olive harvest",
    ],
  },
  {
    icon: Car,
    ...
    values: [
      "🚗 Easily reached from Petra and Molyvos",
  ...
  },
  {
    ...
    label: "Local Tip",
    values: [
      "Visit just before sunset for panoramic views over Petra and the northern coast.",
    ],
  },
];
...
const nearbyPlaces = [
  {
    title: "Petra (8 min)",
    text: "Visit the famous church on the rock and the sandy beach.",
    href: "/villages/petra",
    icon: Landmark,
  },
  {
    title: "Molyvos (15 min)",
    text: "Explore the medieval castle and picturesque harbour.",
    href: "/villages/molyvos",
    icon: Home,
  },
  {
    title: "Anaxos (10 min)",
    text: "Relax on one of Lesvos' longest sandy beaches.",
    href: "/villages/anaxos",
    icon: Sun,
  },
  {
    title: "Lepetymnos (25 min)",
    text: "Discover mountain landscapes and traditional villages.",
  ...
  return (
      <main className="overflow-hidden bg-[#f6f1e8] text-stone-950">
            ...
            <div className="grid w-full gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:items-end">
              ...
              >
                ...
                <p className="mt-8 max-w-2xl text-base leading-7 text-white/70 sm:text-lg">
                  Perched on the green hills above Petra, Vafeios is one of Lesvos'
                  best-preserved traditional villages. Stone-built houses, narrow cobbled
                  streets, olive groves and breathtaking views over the northern coastline
                  create an authentic island experience far from the crowds.
                </p>
        ...
        >
          <div>
            <SectionHeading
                eyebrow="Why visit Vafeios"
                title="A timeless mountain village above the sea"
                description="Vafeios combines traditional architecture, quiet streets and spectacular views, making it one of the most authentic villages in northern Lesvos."
            />
            ...
            <motion.div {...fadeUp} className="mt-9 border-l-2 border-amber-400 pl-5">
              <p className="text-xl font-semibold leading-8 text-stone-800">
                “Where stone houses meet endless olive groves.”
              </p>
            </motion.div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
              ...
              >
                ...
                <a
                    href="https://maps.app.goo.gl/6LB8s9zTGZew9Nt87"
                    target="_blank"
                    rel="noreferrer"
              ...
              >
                ...
                <div className="h-[430px] sm:h-[540px]">
                  <iframe
                      title="Map of Vafeios"
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d11379.809445502564!2d26.2124727916229!3d39.341209338642834!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14ba9ac8cd3d40ef%3A0x19a92c2eeb149079!2zzpLOsc-GzrXOuc-Mz4IgODExIDA4!5e1!3m2!1sel!2sgr!4v1781785778111!5m2!1sel!2sgr"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      loading="lazy"
