...
const quickFacts = [
  ...
  { value: "~1,400 residents", label: "Population" },
  { value: "Traditional village life", label: "Famous for" },
  { value: "~7 km / 15 minutes", label: "From Mytilene" },
  { value: "Local culture & relaxation", label: "Best for" },
];
...
const highlights = [
  {
    ...
    text: "Pamfila offers a peaceful residential atmosphere with traditional houses, narrow streets and an authentic sense of everyday life on Lesvos.",
  },
  {
    icon: Landmark,
    title: "Local Heritage",
    text: "Historic churches, old neighbourhoods and traditional architecture reflect the village's long cultural and religious heritage.",
  },
  {
    icon: Waves,
    title: "Coastal Location",
    text: "Its position near the eastern coast provides easy access to the sea, coastal views and nearby beaches.",
  },
  {
    icon: Sun,
    title: "Close to Mytilene",
    text: "Pamfila combines a quiet village atmosphere with convenient access to the shops, restaurants and attractions of Mytilene.",
  },
];
...
const practicalInfo = [
  {
    ...
    value:
      "☀️ May–October: Warm weather and pleasant coastal conditions. 🌿 Spring is especially beautiful for walking and exploring the surrounding countryside.",
  },
  {
    icon: Car,
    label: "Transport",
    value:
      "Pamfila is around 15 minutes from Mytilene by car. Local bus services may be available, but a car offers greater flexibility.",
  },
  {
    icon: Star,
    label: "Local Specialties",
    value:
      "Fresh seafood, olive oil, local olives, Ladotyri cheese, traditional mezedes and Lesvos ouzo.",
  },
  {
    icon: Star,
    label: "Local Tip",
    value:
      "Walk through the village streets and enjoy a coffee or meal at a local café or taverna for an authentic experience away from busy tourist areas.",
  },
  {
    icon: Star,
    label: "Stay Longer",
    value:
      "Pamfila is a convenient base for exploring Mytilene, eastern Lesvos and nearby coastal villages without staying in the city centre.",
  },
];
...
const guideCards = [
  {
    eyebrow: "Stay",
    title: "Peaceful local accommodation",
    image: "/hotel-placeholder.jpg",
    description:
      "Stay close to Mytilene while enjoying the quieter rhythm and welcoming atmosphere of a traditional village.",
    href: "/stay",
  },
  {
    eyebrow: "Taste",
    title: "Traditional local flavours",
    image: "/restaurant-placeholder.jpg",
    description:
      "Discover homemade dishes, fresh seafood and classic Lesvos mezedes in nearby cafés and tavernas.",
    href: "/food",
  },
  {
    eyebrow: "Explore",
    title: "Eastern Lesvos",
    image: "/attractions-placeholder.jpg",
    description:
      "Explore coastal villages, historic landmarks and the cultural attractions of Mytilene within a short drive.",
    href: "/explore",
  },
];
...
const nearbyPlaces = [
  {
    title: "Mytilene (10–15 min)",
    text: "The island capital offers museums, a historic castle, shopping streets, cafés, restaurants and ferry connections.",
    href: "/destinations/mytilene",
    icon: Home,
  },
  {
    title: "Thermi (10–15 min)",
    text: "A coastal settlement known for its waterfront, traditional tavernas, beaches and nearby archaeological sites.",
    href: "/villages/thermi",
    icon: Waves,
  },
  {
    title: "Roman Aqueduct of Moria (15–20 min)",
    text: "One of Lesvos' most impressive ancient monuments, featuring preserved stone arches from the Roman period.",
    href: "/attractions/roman-aqueduct-moria",
    icon: Landmark,
  },
  {
    title: "Agiasos (40–45 min)",
    text: "A picturesque mountain village famous for traditional architecture, local crafts, churches and chestnut forests.",
...
export default function PamfilaPage() {
  return (
      <main className="overflow-hidden bg-[#f6f1e8] text-stone-950">
            ...
            <div className="grid w-full gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:items-end">
              ...
              >
                ...
                <p className="mt-8 max-w-2xl text-base leading-7 text-white/68 sm:text-lg sm:leading-8 md:text-xl">
                  Pamfila is a peaceful traditional village on the eastern coast of Lesvos, offering local charm, coastal scenery, and easy access to Mytilene.
                </p>
        ...
        >
          <div>
            <SectionHeading
                eyebrow="Why visit Pamfila"
                title="Authentic Village Life Near Mytilene."
                description="Visit Pamfila for its peaceful village atmosphere, traditional character, coastal setting, and convenient location close to Mytilene."
            />
            ...
            <motion.div {...fadeUp} className="mt-9 border-l-2 border-amber-400 pl-5">
              <p className="text-xl font-semibold leading-8 text-stone-800">
                “Where village tradition meets the calm of the Aegean.”
              </p>
            </motion.div>
          </div>
