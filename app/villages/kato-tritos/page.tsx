...
const quickFacts = [
  { label: "Region", value: "Southeastern Lesvos" },
  { label: "Population", value: "~520 res." },
  { label: "Distance from Mytilene", value: "~15.5 km" },
  { label: "Famous for", value: "Quiet village life" },
  { label: "Best for", value: "Slow travel" },
  { label: "Nearby coast", value: "Pigadakia" },
];
...
const highlights = [
  {
    ...
    text: "Kato Tritos is a peaceful village in southeastern Lesvos, offering a quiet atmosphere, local character and an authentic glimpse into everyday island life away from the busier coastal resorts.",
  },
  {
    icon: TreePine,
    title: "Countryside Setting",
    text: "Surrounded by rural landscapes, olive groves and gentle hills, Kato Tritos is ideal for visitors who enjoy scenic drives, photography and peaceful countryside walks.",
  },
  {
    icon: Compass,
    title: "Great Base for Exploring",
    text: "Its location between Mytilene, Gera and the inland villages of Lesvos makes Kato Tritos a convenient stop or base for exploring the southeastern side of the island.",
  },
  {
    icon: Waves,
    title: "Close to Pigadakia",
    text: "Kato Tritos is located close to Pigadakia, a small nearby coastal area, giving visitors easy access to the sea while still enjoying the calm of an inland village.",
  },
];
...
const practicalInfo = [
  {
    ...
    values: [
      "• 🌸 April–May: Mild weather, green countryside and ideal conditions for walking.",
      "• ☀️ June–September: Warm weather and easy access to nearby coastal areas.",
      "• 🍂 October: Olive harvest season, pleasant temperatures and peaceful village life.",
    ],
  },
  {
    icon: Car,
    label: "Transport",
    values: [
      "🚗 Kato Tritos is best reached by car from Mytilene or nearby villages.",
      "🚗 A rental car is recommended if you want to explore Gera, Agiasos, Mytilene and the surrounding countryside.",
    ],
  },
  {
    icon: Star,
  ...
  },
  {
    ...
    label: "Local Tip",
    values: [
      "Visit Kato Tritos as part of a relaxed driving route through southeastern Lesvos. Combine it with nearby villages, Pigadakia, Gera and Mytilene for a day of quiet countryside scenery, local food and authentic island atmosphere. 🌿🏡🚗",
    ],
  },
];
...
const guideCards = [
  {
    eyebrow: "Stay",
    title: "Peaceful countryside stays",
    image: "/hotel-placeholder.jpg",
    description:
        "Stay in quiet accommodation near Mytilene or Gera while enjoying the calm atmosphere of southeastern Lesvos.",
    href: "/stay",
  },
  {
    eyebrow: "Taste",
    ...
    description:
        "Enjoy homemade Lesvian dishes, local cheeses, olive oil, ouzo and traditional village hospitality.",
    href: "/food",
  },
  {
    eyebrow: "Explore",
    title: "Villages, coast & countryside",
    image: "/attractions-placeholder.jpg",
    description:
        "Discover nearby villages, scenic rural routes, small coastal spots and cultural landmarks around southeastern Lesvos.",
    href: "/explore",
  },
];
...
const nearbyPlaces = [
  {
    title: "Mytilene (20 min)",
    text: "The island's capital, offering museums, shopping, restaurants, the castle and the main ferry port.",
    href: "/villages/mytilene",
    icon: Home,
  },
  {
    title: "Pigadakia (5 min)",
    text: "A small nearby coastal area close to Kato Tritos, ideal for a quiet stop by the sea.",
    href: "/villages/pigadakia",
    icon: Waves,
  },
  {
    title: "Agiasos (15 min)",
    text: "One of Lesvos' most atmospheric mountain villages, known for its traditional architecture, religious heritage and local crafts.",
    href: "/villages/agiasos",
    icon: Landmark,
  },
  {
    title: "Gera Gulf (15 min)",
    text: "A beautiful gulf area with seaside villages, calm waters, tavernas and scenic views across southeastern Lesvos.",
    href: "/villages/gera",
    icon: Waves,
  },
];
...
export default function KatoTritosPage() {
  return (
