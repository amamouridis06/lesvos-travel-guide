...
const quickFacts = [
  ...
  { label: "Distance from Mytilene", value: "26 km" },
  { label: "Best Known For", value: "Panagia Church" },
  { label: "Local Craft", value: "Wood Carving" },
  { label: "Mountain", value: "Mount Olympus" },
...
const highlights = [
  {
    icon: Landmark,
    title: "Church of Panagia",
    text: "One of the most important pilgrimage sites in the Aegean, housing a revered icon of the Virgin Mary.",
  },
  {
    icon: Palette,
    title: "Traditional Crafts",
    text: "Agiasos is famous for its wood carving, pottery and folk art traditions.",
  },
  {
    icon: Home,
    title: "Stone-Paved Alleys",
    text: "Wander through narrow cobbled streets lined with traditional houses, cafés and workshops.",
  },
  {
    icon: Sun,
    title: "Mount Olympus",
    text: "A perfect base for hiking and exploring Lesvos' highest mountain and chestnut forests.",
  },
];
...
const practicalInfo = [
  {
    ...
    values: [
      "🌸 April–May: Wildflowers and hiking season",
      "☀️ June–September: Village festivals and mountain escapes",
      "🍂 October–November: Beautiful autumn colours in the chestnut forests",
    ],
  },
  {
    icon: Car,
    ...
    values: [
      "🚗 Easy access from Mytilene by car",
      "🚌 Regular bus connections throughout the year",
    ],
  },
  {
    icon: Star,
  ...
  },
  {
    ...
    label: "Local Tip",
    values: [
      "Combine Agiasos with Mount Olympus and the chestnut forests for one of Lesvos' most authentic inland experiences.",
    ],
  },
];
  ...
  return (
      <main className="overflow-hidden bg-[#f6f1e8] text-stone-950">
            ...
            <div className="grid w-full gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:items-end">
              ...
              >
                ...
                <p className="mt-8 max-w-2xl text-base leading-7 text-white/68 sm:text-lg sm:leading-8 md:text-xl">
                  Agiasos is one of the most picturesque villages in Lesvos, nestled on the slopes of Mount Olympus.
                  Known for its religious heritage, traditional crafts and charming cobbled streets, it offers visitors an
                  authentic glimpse into the island's cultural heart.
                </p>
        ...
        >
          <div>
            <SectionHeading
                eyebrow="Why visit Agiasos"
                title="Culture, tradition and mountain beauty"
                description="Agiasos is famous for its historic church, vibrant local traditions and artisan workshops. Surrounded by forests and mountain scenery, it is one of the most atmospheric villages in Lesvos."
            />
          ...
          >
            <div className="relative h-[380px] sm:min-h-[560px] overflow-hidden rounded-[2.25rem]">
              <Image
                  src="/Agiasos/Agiasos-village.jpg"
                  alt="Agiasos"
                  fill
        ...
        <section id="highlights" className="bg-stone-950 py-20 text-white sm:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <SectionHeading
                ...
                title="The traditions that define Agiasos"
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
              ...
              >
                ...
                <a
                    href="https://maps.app.goo.gl/PdyN1Uq7fpLCPVkU7"
                    target="_blank"
                    rel="noreferrer"
              ...
              >
                ...
                <div className="h-[430px] sm:h-[540px]">
                  <iframe
                      title="Map of Agiasos"
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6548.885952738317!2d26.3717225!3d39.083467549999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14baf4f524339a7d%3A0x400bd2ce2b9b4d0!2sAgiasos%20811%2001!5e1!3m2!1sen!2sgr!4v1781712773261!5m2!1sen!2sgr"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      loading="lazy"
