...
export default function MolyvosPage() {
  return (
    <main className="bg-neutral-100 text-neutral-900">
      ...
      {/* HERO */}
      <section className="relative h-[70vh] bg-[url('/skala-kallonis.jpg')] bg-cover bg-center">
      ...
      <section className="max-w-4xl mx-auto px-6 py-16 space-y-10">
        ...
        <div>
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3268.7127752453366!2d26.207192726145344!3d39.20675477165979!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14ba92612321ace7%3A0xa00bd2f74c26dd0!2sSkala%20Kallonis!5e1!3m2!1sen!2sgr!4v1776207415541!5m2!1sen!2sgr" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        {/* BACK BUTTON */}
        {/* <div>
          <a
            href="/"
