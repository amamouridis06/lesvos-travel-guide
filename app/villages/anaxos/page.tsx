...
const quickFacts = [
  ...
  { label: "Distance from Mytilene", value: "60 km" },
  { label: "Best Known For", value: "Sandy Beach" },
  { label: "Ideal For", value: "Families" },
  { label: "Nearby Town", value: "Petra" },
  { label: "Character", value: "Seaside Resort" },
];
...
const highlights = [
  {
    icon: Waves,
    title: "Anaxos Beach",
    text: "A long sandy beach with shallow, crystal-clear waters ideal for families and swimming.",
  },
  {
    icon: Sun,
    title: "Relaxed Atmosphere",
    text: "A peaceful resort offering a slower pace and laid-back summer holidays.",
  },
  {
    icon: Home,
    title: "Beachfront Tavernas",
    text: "Enjoy fresh seafood, local dishes and sea views just steps from the shore.",
  },
  {
    icon: Landmark,
    title: "Explore Northern Lesvos",
    text: "Perfectly located between Petra and Molyvos, two of the island's most popular destinations.",
  },
];
...
const practicalInfo = [
  {
    ...
    values: [
      "🌸 May–June: Warm weather and quieter beaches",
      "☀️ July–September: Peak beach season",
      "🍂 October: Pleasant sea temperatures and fewer visitors",
    ],
  },
  {
    icon: Car,
    ...
    values: [
      "🚗 A car is useful for exploring northern Lesvos",
      "🚌 Bus connections link Anaxos with Petra and Mytilene",
    ],
  },
  {
    icon: Star,
  ...
  },
  {
    ...
    label: "Local Tip",
    values: [
      "Stay in Anaxos and visit Petra and Molyvos in the evening for dining, sightseeing and sunsets.",
    ],
  },
];
...
export default function MantamadosPage() {
  return (
      <main className="overflow-hidden bg-[#f6f1e8] text-stone-950">
        ...
        <section className="relative min-h-[100svh] overflow-hidden bg-stone-950">
          <Image
              src="/Mantamados/Mantamados-sunset.jpg"
              alt="Mantamados in Lesvos"
              fill
              priority
              sizes="100vw"
            ...
            <div className="grid w-full gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:items-end">
              ...
              >
                ...
                <p className="mt-8 max-w-2xl text-base leading-7 text-white/68 sm:text-lg sm:leading-8 md:text-xl">
                  Anaxos is a charming seaside resort on the northern coast of Lesvos, known for its golden sandy beach, shallow waters and relaxed atmosphere. Combining easy-going beach holidays with access to some of the island's most beautiful villages, it is a favourite destination for families and couples alike.
                </p>
        ...
        >
          <div>
            <SectionHeading
                eyebrow="Why visit Anaxos"
                title="A relaxed beach escape in northern Lesvos"
                description="With its wide sandy beach, family-friendly waters and welcoming atmosphere, Anaxos is one of the best places on the island for a peaceful seaside holiday."
            />
            ...
            <motion.div {...fadeUp} className="mt-9 border-l-2 border-amber-400 pl-5">
              <p className="text-xl font-semibold leading-8 text-stone-800">
                “Simple pleasures, endless sea views.”
              </p>
            </motion.div>
          </div>
          ...
          >
            <div className="relative h-[380px] sm:min-h-[560px] overflow-hidden rounded-[2.25rem]">
              <Image
                  src="/Gavathas/Gavathas-village.jpg"
                  alt="Gavathas"
                  fill
        ...
        <section id="highlights" className="bg-stone-950 py-20 text-white sm:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <SectionHeading
                ...
                title="The traditions that define Gavathas"
                description="Religious heritage, local craftsmanship and authentic Lesvian culture."
                centered
                light
            />
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
              ...
              >
                ...
                <a
                    href="https://maps.app.goo.gl/4YWGBpE91WkDxAPKA"
                    target="_blank"
                    rel="noreferrer"
              ...
              >
                ...
                <div className="h-[430px] sm:h-[540px]">
                  <iframe
                      title="Map of Anaxos"
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13054.102511440271!2d26.142020318200686!3d39.31807823299286!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14ba90b837764a03%3A0xba0ad44512283bab!2sAnaxos%20Skoutarou%20811%2009!5e1!3m2!1sen!2sgr!4v1781713641629!5m2!1sen!2sgr"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      loading="lazy"
        ...
        <section className="relative overflow-hidden py-28 sm:py-36">
          <Image
              src="/Mantamados/Mantamados-hero.jpg"
              alt="Mantamados"
              fill
              sizes="100vw"
              className="object-cover"
