...
const quickFacts = [
  ...
  { label: "Distance from Mytilene", value: "37 km" },
  { label: "Best Known For", value: "Taxiarchis Monastery" },
  { label: "Local Specialty", value: "Ladotyri Cheese" },
  { label: "Nearby Beach", value: "Tsonia Beach" },
...
const highlights = [
  ...
  },
  {
    ...
    text: "Discover local ceramic workshops that continue a craft passed down through generations.",
  },
  {
    icon: Waves,
    title: "Tsonia Beach",
    text: "A beautiful beach with distinctive red sands and crystal-clear waters, just a short drive from the village.",
  },
];
...
const practicalInfo = [
  {
    ...
    values: [
      "🌸 April–May: Green landscapes and pilgrimage season",
      "☀️ June–September: Beach weather and outdoor dining",
      "🍂 October: Mild temperatures and fewer crowds",
    ],
  },
  {
    icon: Car,
    ...
    values: [
      "🚗 A car is the easiest way to explore the area",
      "🚌 Bus connections are available from Mytilene",
    ],
  },
  {
    icon: Star,
  ...
  },
  {
    ...
    label: "Local Tip",
    values: [
      "Combine Mantamados, Petra and Molyvos for one of the most scenic day trips in northern Lesvos.",
    ],
  },
];
  ...
  return (
      <main className="overflow-hidden bg-[#f6f1e8] text-stone-950">
            ...
            <div className="grid w-full gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:items-end">
              ...
              >
                ...
                <p className="mt-8 max-w-2xl text-base leading-7 text-white/68 sm:text-lg sm:leading-8 md:text-xl">
                  Mantamados is one of the most historic villages of Lesvos, famous for the
                  Taxiarchis Monastery, traditional pottery workshops and the production of
                  Ladotyri cheese. Combining religious heritage, local traditions and nearby
                  coastal beauty, it offers an authentic glimpse into northern Lesvos.
                </p>
        ...
        >
          <div>
            <SectionHeading
                eyebrow="Why visit Mantamados"
                title="Tradition, faith and authentic village life"
                description="Mantamados is known throughout Greece for the Taxiarchis Monastery,
its rich religious tradition, local crafts and famous Ladotyri cheese. It is
one of the best places to experience the authentic culture of northern Lesvos."
            />
            ...
            <motion.div {...fadeUp} className="mt-9 border-l-2 border-amber-400 pl-5">
              <p className="text-xl font-semibold leading-8 text-stone-800">
                “Home of Taxiarchis, Ladotyri and timeless traditions.”
              </p>
            </motion.div>
          </div>
          ...
          >
            <div className="relative h-[380px] sm:min-h-[560px] overflow-hidden rounded-[2.25rem]">
              <Image
                  src="/Mantamados/Mantamados-village.jpg"
                  alt="Mantamados"
                  fill
        ...
        <section id="highlights" className="bg-stone-950 py-20 text-white sm:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <SectionHeading
                ...
                title="The traditions that define Mantamados"
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
              ...
              >
                ...
                <a
                    href="https://maps.app.goo.gl/VQKc8qhKyYFxLmQK6"
                    target="_blank"
                    rel="noreferrer"
              ...
              >
                ...
                <div className="h-[430px] sm:h-[540px]">
                  <iframe
                      title="Map of Mantamados"
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6527.719692773762!2d26.33618855!3d39.3109134!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14ba8669ac32bde3%3A0x400bd2ce2b9b540!2sMantamados%20811%2004!5e1!3m2!1sen!2sgr!4v1781707122564!5m2!1sen!2sgr"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      loading="lazy"
