...
const quickFacts = [
    ...
    { label: "Distance from Mytilene", value: "65 km" },
    { label: "Best Known For", value: "Long Sandy Beach" },
    { label: "Character", value: "Seaside Village" },
    { label: "Ideal For", value: "Relaxation" },
...
const highlights = [
    {
        icon: Waves,
        title: "Gavathas Beach",
        text: "A long sandy beach with shallow waters, ideal for families and relaxed summer days.",
    },
    {
        icon: Sun,
        title: "Peaceful Atmosphere",
        text: "One of the quietest coastal destinations in Lesvos, far from crowded resorts.",
    },
    {
        icon: Home,
        title: "Traditional Seafront",
        text: "Enjoy local tavernas, fresh seafood and authentic island hospitality by the sea.",
    },
    {
        icon: Landmark,
        title: "Western Lesvos",
        text: "An excellent base for exploring the island's volcanic landscapes and hidden beaches.",
    },
];
...
const practicalInfo = [
    {
        ...
        values: [
            "🌸 May–June: Warm weather and quiet beaches",
            "☀️ July–September: Swimming and seaside dining",
            "🍂 October: Mild temperatures and peaceful surroundings",
        ],
    },
    {
        icon: Car,
    ...
    },
    {
        ...
        label: "Local Tip",
        values: [
            "Combine Gavathas, Sigri and the Petrified Forest for a perfect day exploring western Lesvos.",
        ],
    },
];
    ...
    return (
        <main className="overflow-hidden bg-[#f6f1e8] text-stone-950">
                    ...
                    <div className="grid w-full gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:items-end">
                        ...
                        >
                            ...
                            <p className="mt-8 max-w-2xl text-base leading-7 text-white/68 sm:text-lg sm:leading-8 md:text-xl">
                                Gavathas is a peaceful seaside village on the western coast of Lesvos, known for its long sandy beach, crystal-clear waters and relaxed atmosphere. It is an ideal destination for visitors seeking authentic island life, beautiful sunsets and uncrowded shores.
                            </p>
            ...
            >
                <div>
                    <SectionHeading
                        eyebrow="Why visit Gavathas"
                        title="One of Lesvos' most peaceful seaside escapes"
                        description="With its wide sandy beach, family-friendly waters and laid-back atmosphere, Gavathas offers a quieter side of the island and easy access to the natural wonders of western Lesvos."
                    />
