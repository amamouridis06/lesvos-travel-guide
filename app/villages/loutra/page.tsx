...
const quickFacts = [
  ...
  { label: "Population", value: "500 res." },
  { label: "Distance from Mytilene", value: "~10 km (10–15 min)" },
  { label: "Famous for", value: "Island tranquility" },
  { label: "Best for", value: "Countryside wellness" },
  { label: "Name origin", value: "Thermal heritage" },
];
...
const highlights = [
  {
    ...
    text: "Loutra has been known since antiquity for its natural hot springs. The mineral-rich waters have traditionally been used for relaxation and therapeutic purposes, making the village one of Lesvos' historic spa destinations.",
  },
  {
    icon: Home,
    title: "Traditional Village",
    text: "Built among olive groves, Loutra has preserved its traditional stone houses, narrow streets, and quiet village atmosphere. It offers an authentic glimpse into everyday life on Lesvos.",
  },
  {
    icon: Home,
    title: "Excellent Base for Exploring",
    text: "Thanks to its location just outside Mytilene, Loutra is an ideal base for visiting the island's capital while enjoying the tranquility of the countryside.",
  },
  {
    icon: TreePine,
    title: "Countryside & Olive Groves",
    text: "The area surrounding Loutra is covered with centuries-old olive trees, making it perfect for scenic walks, cycling, and photography.",
  },
];
...
const practicalInfo = [
  {
    ...
    values: [
      "•\t🌸 April–May: Mild weather, blooming countryside, ideal for walking.",
      "•\t☀️ June–September: Warm temperatures and easy access to nearby beaches.",
      "•\t🍂 October: Olive harvest season and pleasant weather.",
    ],
  },
  {
    icon: Car,
    label: "Transport",
    values: [
      "🚗 Loutra is easily reached by car or local bus from Mytilene.",
      "🚗 A rental car is recommended if you plan to explore the rest of the island.",
    ],
  },
  {
    icon: Star,
