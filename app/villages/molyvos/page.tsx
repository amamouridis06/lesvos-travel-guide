...
const quickFacts = [
  ...
  { value: "Molyvos Castle", label: "Landmark" },
  { value: "Stone Architecture", label: "Character" },
  { value: "5 km from Petra", label: "Nearby" },
];
...
const highlights = [
  ...
  },
  {
    ...
    text: "Stone-built houses and picturesque cobbled streets.",
  },
  {
    icon: Waves,
    title: "Scenic Harbor",
    text: "A charming fishing harbor lined with cafés and tavernas.",
  },
  {
    icon: Camera,
    title: "Panoramic Views",
    text: "Stunning views across the Aegean Sea and the Turkish coast.",
  },
  {
    icon: Sun,
    title: "Sunsets",
    text: "Among the most beautiful sunset spots on Lesvos.",
  },
  {
    icon: UtensilsCrossed,
    title: "Local Cuisine",
    text: "Fresh seafood and authentic Lesvian flavors.",
  },
];
...
const nearbyPlaces = [
  {
    title: "Petra",
    text: "Seaside village famous for its church on the rock.",
    href: "/villages/petra",
    icon: Church,
  },
  {
  ...
  {
    title: "Eftalou",
    text: "Natural hot springs overlooking the sea.",
      ...
      <main className="overflow-hidden bg-[#f6f1e8] text-stone-950">
            ...
            <div className="grid w-full gap-12 lg:grid-cols-[1.08fr_0.92fr] lg:items-end">
              ...
              >
                ...
                <p className="mt-8 max-w-2xl text-base leading-7 text-white/68 sm:text-lg sm:leading-8 md:text-xl">
                  A captivating hilltop village crowned by a medieval castle, where cobbled streets, traditional stone houses, and breathtaking sea views create one of Greece's most enchanting destinations.
                </p>
        ...
        >
          <div>
            <SectionHeading
                eyebrow="Why Molyvos"
                title="A village frozen in time"
                description="Molyvos is one of the most beautiful traditional settlements in Greece. Its medieval castle, stone-built houses, narrow cobbled alleys, and spectacular Aegean views offer visitors a unique blend of history, culture, and island charm."
            />
