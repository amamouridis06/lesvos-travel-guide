...
const hotel = {
    ...
    body: [
        ...
        "Fully renovated and thoughtfully equipped, it features complimentary Wi-Fi, air conditioning, a washing machine, and a fully equipped kitchen, providing everything you need for a relaxing and comfortable stay."
    ],
    highlights: [
        { label: "Breakfast", value: "Νο" },
    ...
    bookUrl:
        "https://www.booking.com/Share-f36s9EP ",
};
