...
//             period: "/month",
//             description:
//                 "Για ενοικιαζόμενα αμάξια, μια απλή προβολή",
//             features: [
//               "Καταχώριση εταιρείας",
//               "Στοιχεία επικοινωνίας",
//               "Social Media",
//               "Εως 7 φωτογραφίες",
//               "Εμφάνιση σε κατηγορίες δραστηριοτήτων",
...
//               "Όλα του Basic",
//               "1 stories/posts",
//               "Συμμετοχή στα Top Experiences",
//               "Εως 17 φωτογραφίες",
//               "Χάρτης τοποθεσίας",
//               "Εμφάνιση σε Recommended Rentals",
//               "Badge Verified Partner",
//               "Υποστήριξη μέσω τηλεφωνου"
//             ],
//             cta: "Ξεκίνα τώρα",
//             highlighted: true,
//           },
...
//         period: "/month",
//         description:
//             "Για επιχειρίσης με δραστηριότητες που θέλουν επαγγελματική online παρουσία.",
//         features: [
//           "Καταχώριση στον οδηγό",
//           "Έως 15 φωτογραφίες",
